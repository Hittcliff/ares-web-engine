...
<body id="main_body">
  <?php if($_SESSION["permisions"] == 2){ ?>
    <div id="form_container">
        <h1><a>Добавление аниме</a></h1>
        <form id="form" class="appnitro" enctype="multipart/form-data" method="post" action="functions.php">
            ...
            <ul>
                ...
                <li id="li_5">
				 ...
				 <li id="li_9">
                    <label class="description" for="element_9">Ссылка на Kodic </label>
                    <div>
  ...
  <?php } else {
    echo 'У вас недостаточно прав. Вернитесь на главную страницу и авторизуйтесь!';
  } ?>
</body>
</html>
